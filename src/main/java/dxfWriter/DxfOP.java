...
public class DxfOP {
    ...
    public void createPolyLine(List<WB_Point> pts, String layer) {
    ...
    public void createPolyLineByCoords(List<WB_Coord> pts, String layer) {
        DXFData polyline = new DXFData();
        polyline.Count = pts.size();
        polyline.Points = new ArrayList();
        polyline.LayerName = Objects.requireNonNullElse(layer, "default_layer");
    ...
    public void createPolygon(List<WB_Point> pts, String layer) {
        DXFData polyline = new DXFData();
        ...
        WB_Point o = pts.get(0);
        polyline.Points.add(new DXFPoint(o.xf(), o.yf(), 0));
        dxfExport.addPolyline(polyline);
    }

    public void createHatch(List<WB_Point> pts,String layer){
